...
if __name__ == "__main__":
    ...
    # regular = sarsa_algorithm(episode=number_episode, gamma=1, alpha=0.8, epsilon=0.1, max_time_step=number_episode, grid_world_size=grid_size)
    ...
    # plot.save_q_value(q_value, type_graph_name="Sarsa")
...
#     plot.save_q_value(q_value, type_graph_name="Q_Learning_alpha_1")
...
#     plot.save_q_value(q_value, type_graph_name="Double_Q_Learning_alpha_1")
    ...
    plot.plot_episode_time_step(cumulative_reward, type_graph = "cumulative_reward")
    plot.plot_episode_time_step(step_number, type_graph = "step_number")
